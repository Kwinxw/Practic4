...
namespace Project4
{
    class Program
    {
        static string connectionString = "Server=sql.bsite.net\\MSSQL2016;Database=kwinxw_Practic3;User Id=kwinxw_Practic3;Password=Vadim2006;TrustServerCertificate=true;";
        ...
        {
            Console.Clear();
            DisplayUsers("SELECT UserID, Username, Email, CreatedAt, UpdatedAt FROM [Users]");
        }
        ...
        static void AddUser()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    connection.Open();
                    using (SqlCommand command = new SqlCommand("INSERT INTO [Users] (Username, PasswordHash, Email) VALUES (@Username, @PasswordHash, @Email)", connection))
                    {
